...
export function useEmbedController(props: EmbedClientProps) {
  const {
  ...
  const ctrl = {
    ...
    identifiedUserRef,
    identifiedUserTokenRef,
    pageContextRef,
    lastEmittedSessionIdRef,
    consentPromptVisible,
    setConsentPromptVisible,
    baseSessionKey,
    sessionStorageKey,
    unreadStorageKey,
    lastReadStorageKey,
    ...
    handleStopStreaming,
    isSubmittingRef,
    lastHostTextCommandRef,
    interceptCallbacksRef,
    interceptorsActiveRef,
    isCollapsed,
    setIsCollapsed,
    previewStateRestoredRef,
    getAuthToken,
    authToken,
    authError,
    authErrorCode,
...
export type EmbedController = ReturnType<typeof useEmbedController>;
